...
//      }else 
    ...
    {yql:{xpath:"json", from:'json'
          , url: function(externalurl){return '//skitch.com/oembed/?format=json&url='+externalurl}
    ...
    new $.fn.oembed.OEmbedProvider("stackoverflow", "rich", ["stackoverflow.com/questions/[\\d]+"], "//api.stackexchange.com/2.2/questions/$1?body=true&site=stackoverflow&jsonp=?"
